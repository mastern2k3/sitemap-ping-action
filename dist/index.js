...
Object.defineProperty(exports, "__esModule", { value: true });
const Google_1 = __webpack_require__(337);
const Bing_1 = __webpack_require__(509);
const core = __webpack_require__(470);
const validUrl = __webpack_require__(190);
...
Promise.all([
    (new Google_1.default()).ping(sitemapUrl),
    (new Bing_1.default()).ping(sitemapUrl),
]).then(() => {
...
class Google {
    async ping(sitemapUrl) {
        const res = await got_1.default.get(`http://www.google.com/ping?sitemap=${sitemapUrl}`);
...
class Bing {
    async ping(sitemapUrl) {
        const res = await got_1.default.get(`http://www.bing.com/ping?sitemap=${sitemapUrl}`);
        return res.statusCode === 200;
    }
}
